		...
		<div class="container">
			...
			?>
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					...
					<?php
					if(get_field('map')): 
					$map_image = wp_get_attachment_image_src( get_field('map') , 'content-image' );
					$map_image_large = wp_get_attachment_image_src( get_field('map') , 'full' );
					?>
						<a href="<?php echo $map_image_large[0]; ?>" title="Large Map" class="lightbox" />
							<img src="<?php echo $map_image[0]; ?>" alt="Map" class="full-width-image" />
						</a>
					<?php
					else: 
					?>
