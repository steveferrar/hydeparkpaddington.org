...
$(document).ready(function(){
    ...
    // ----- Radio / Checkbox
    // ---------------------------------------------
	$('input[name="options_b"]').click(function() {
		// console.log('Select!');
    	$('.options_organisation').css('display', ($(this).val() === 'I represent an organisation') ? 'block':'none');
   });

   $('input:radio[name="options_a"][value="I live in the area"]').click();
   $('input:radio[name="options_b"][value="I am joining as an individual"]').click();
