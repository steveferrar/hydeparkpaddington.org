	...
	<div id="footer-wrapper">	
		...
		<footer id="footer" class="">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						&copy; Hyde Park Paddington <?php echo date('Y') ?>. All rights reserved. <a href="http://www.wearetourist.com/" target="Tourist" target="_blank" class="hidden-sm hidden-md hidden-lg">Site by Tourist.</a><a href="http://www.wearetourist.com/" target="Tourist" target="_blank" style="display:inline-block; float:right;" class="hidden-xs">Site by Tourist.</a>
					</div>
				</div>
			</div>
		</footer>
