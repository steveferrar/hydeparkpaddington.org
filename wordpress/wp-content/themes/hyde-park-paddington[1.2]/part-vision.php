...
<div id="accordion">
	...
	?>
		...
		<div class="dropdown-item col-xs-12" id="accordion-transport-container">
			<a href="" title="Transport" class="dropdown-link" id="accordion-transport">Transport</a>
	...
	?>
		...
		<div class="dropdown-item col-xs-12" id="accordion-environment-container">
			<a href="" title="Environment" class="dropdown-link" id="accordion-environment">Environment</a>
			<div class="dropdown-content">
	...
	?>
		...
		<div class="dropdown-item col-xs-12" id="accordion-culture-container">
			<a href="" title="Culture" class="dropdown-link" id="accordion-culture">Culture</a>
			<div class="dropdown-content">
	...
	?>
		...
		<div class="dropdown-item col-xs-12" id="accordion-promotion-container">
			<a href="" title="Promotion" class="dropdown-link" id="accordion-promotion">Promotion</a>
			<div class="dropdown-content">
	...
	?>
		...
		<div class="dropdown-item col-xs-12" id="accordion-investment-container">
			<a href="" title="Investment" class="dropdown-link" id="accordion-investment">Investment</a>
			<div class="dropdown-content">
	...
	?>
		...
		<div class="dropdown-item col-xs-12" id="accordion-partnership-container">
			<a href="" title="Partnership" class="dropdown-link" id="accordion-partnership">Partnership</a>
			<div class="dropdown-content">
